...
import cifar10
TRAIN_DIR = 'cifar10_train_original'
EVAL_DIR='cifar10_eval_original'
os.environ["CUDA_VISIBLE_DEVICES"] = '-1'

FLAGS = tf.app.flags.FLAGS
tf.app.flags.DEFINE_string('eval_dir', EVAL_DIR, """Directory where to write event logs.""")
tf.app.flags.DEFINE_string('eval_data', 'test', """Either 'test' or 'train_eval'.""")
tf.app.flags.DEFINE_string('checkpoint_dir', TRAIN_DIR, """Directory where to read model checkpoints.""")
